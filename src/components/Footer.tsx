      ...
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-3">
            <a href="https://www.instagram.com/anna__storez?igsh=MWt5MThvZ3ZlMm50bg==" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/10 hover:bg-[#E4405F] flex items-center justify-center transition-colors cursor-pointer" aria-label="Siga-nos no Instagram">
